...
export const BOARD_NODES: BoardNode[] = [
  ...
  { id: 'matsuyama', name: '松山', type: 'event_random', region: 'shikoku', x: 48, y: 128, description: '道後温泉で運試し' },
  { id: 'uwajima', name: '宇和島', type: 'fishing', region: 'shikoku', x: 42, y: 132, description: '宇和海の釣り' },
  { id: 'takamatsu', name: '高松', type: 'rest', region: 'shikoku', x: 69, y: 120, description: 'うどん県で一息' },
