...
export const BOARD_NODES: BoardNode[] = [
  ...
  { id: 'takamatsu', name: '高松', type: 'rest', region: 'shikoku', x: 66, y: 118, description: 'うどん県で一息' },
  { id: 'shimanto', name: '四万十', type: 'fishing_special', region: 'shikoku', x: 54, y: 138, description: '最後の清流で大物を狙う' },
  { id: 'naruto', name: '鳴門', type: 'event_random', region: 'shikoku', x: 86, y: 124, description: '渦潮の街で運試し' },
  ...
  { id: 'oita', name: '大分', type: 'rest', region: 'kyushu', x: 56, y: 130, description: '温泉で一息' },
