...
export default function EquipmentCard({ equipment, currentLevel, canAfford, canBuy, onBuy }: EquipmentCardProps) {
  const isOwned = equipment.level <= currentLevel;
  const isNext = equipment.level === currentLevel + 1;
      ...
      <div className="flex items-start justify-between mb-2">
        <div>
          <div className="flex items-center gap-1.5">
            ...
            {isOwned && <span className="text-xs text-green-400">装備中</span>}
          </div>
